...
Elm.SuperAgent = Elm.SuperAgent || {};
Elm.SuperAgent.make = function (_elm) {
   "use strict";
   _elm.SuperAgent = _elm.SuperAgent || {};
   if (_elm.SuperAgent.values) return _elm.SuperAgent.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
...
Elm.Main.make = function (_elm) {
   ...
   $SuperAgent = Elm.SuperAgent.make(_elm);
   var _op = {};
   var view = F2(function (address,model) {
      var _p0 = model;
      switch (_p0.ctor)
      {case "Loading": return $Html.text("Loading...");
         case "Overview": return $Html.text("TODO: render Overview");
         default: return $Html.text("TODO: render AepListing");}
   });
   var update = F2(function (action,model) {    var _p1 = action;return model;});
   var NoOp = {ctor: "NoOp"};
   var AepListing = function (a) {    return {ctor: "AepListing",_0: a};};
   var Overview = function (a) {    return {ctor: "Overview",_0: a};};
