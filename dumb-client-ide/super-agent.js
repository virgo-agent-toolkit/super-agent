...
SuperAgent = (function () {
  ...
  // options.css - Css to inject into the container
  // options.js - JS to inject into the container
  // options.lua - Lua to inject into the agent
  ...
  function SuperAgent(domContainer, options) {
    ...
    function onConnect(err, callValue) {
      ...
      call("register", "ide", options.lua)(onRegister);
    }
    ...
    function onAgent(err, agent) {
      ...
      if (options.css) {
        ...
        var css = options.css.replace(/\{[^}]*\}/g, function (block) {
      ...
      if (options.js) {
        ...
        /*jshint evil:true*/
        var fn = new Function("agent","run","call","domBuilder", options.js);
